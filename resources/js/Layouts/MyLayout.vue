    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <header>
                    <nav
                        class=" fixed upper-0 left-0 w-full bg-white border-t shadow z-50 border-gray-200 px-4 lg:px-6 py-4 dark:bg-gray-800">
                        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">

                            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Barangay
                                Online
                                Proccess</span>
                ...
                <section class="relative bg-cover bg-center bg-no-repeat py-8" style="background-image: url('/Images/br.jpg');">
                    <!-- Overlay para dumilim ng kaunti -->
                    <div class="absolute inset-0 bg-black bg-opacity-50"></div>

                    <!-- Content -->
                    <div class="relative py-16 px-4 mx-auto max-w-screen-xl lg:py-24 lg:px-6 text-center text-white">
                        <h2 class="mb-4 text-4xl tracking-tight font-bold">
                            Welcome to <span class="font-extrabold">Digital</span> Barangay Permit
                        </h2>

                        <div class="flex justify-center gap-4 py-24">
                            <span class="text-white border rounded-full px-4 py-2 bg-blue-500">Login</span>
                            <span class="text-white border rounded-full px-4 py-2 bg-green-500">Register</span>
                        </div>
                    </div>
                </section>
                <div class="py-8 mt-6 bg-gray-500">
                    <div class="py-16 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                        <div class="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
                            <h2 class="mb-4 text-4xl tracking-tight font-bold text-gray-900 dark:text-white">Welcome to
                                <span class="font-extrabold">Online</span> Barangay Permit
                            </h2>
                        </div>

                        <div class="flex justify-center gap-4 py-8">
                            <span class="text-black border rounded-full px-4">Login</span>
                            <span class="text-black border rounded-full px-4">Register</span>
                        </div>
                    </div>

                </div>
                <div class="mt-6 py-8 bg-red-500">
                    <div class="py-16 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                        <div class="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
                            <h2 class="mb-4 text-4xl tracking-tight font-bold text-gray-900 dark:text-white">Welcome to
                                <span class="font-extrabold">Online</span> Barangay Permit
