...
<template>
    <div>
            ...
            <div class="flex-none h-full text-center flex items-center justify-center">
                <div class="flex space-x-3 items-center px-3">
                    <!-- <div class="flex-none flex justify-center">
                        <img :src="$page.props.user.profile_photo_url" alt="profile"
                            class="w-8 h-8 shadow rounded-full object-cover" />
                    </div> -->
        ...
        <!-- Sidebar -->
        <aside :class="['w-60 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B]',
            ...
            <div @click="openNav"
                class="-right-6 transition transform ease-in-out duration-500 flex border-4 border-white dark:border-[#0F172A] bg-[#1E293B] dark:hover:bg-blue-500 hover:bg-purple-500 absolute top-2 p-3 rounded-full text-white hover:rotate-45 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={3}
                    stroke="currentColor" class="w-4 h-4">
                    <path strokeLinecap="round" strokeLinejoin="round"
            ...
            <!-- Expanded Sidebar -->
            <div v-if="sidebarOpen" class="max text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]">
                <a href="#"
            ...
            <!-- Collapsed Sidebar -->
            <div v-else class="mini mt-20 flex flex-col space-y-2 w-full h-[calc(100vh)]">
                <a href="#"
        ...
        <!-- Main Content -->
        <div :class="['content transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4',
