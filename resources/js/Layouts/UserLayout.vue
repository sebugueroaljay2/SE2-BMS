...
onMounted(() => {
    if (
        route().current("barangay.clearance") ||
        route().current("business.permit") ||
        route().current("indengency.certificates") ||
        route().current("residency.certificates") ||
        route().current("barangay.health.certificates") ||
        route().current("request.status")
    );
});
                ...
                <div class="min-h-screen flex flex-row ">
                    <div class="flex flex-col w-56 bg-white  overflow-hidden border-2 border-gray-200">
                        ...
                        <div class="flex justify-center  border-b py-2"><span
                                class="text-2xl text-red-600 font-bold">Resident</span></div>
                        <ul class="flex flex-col py-4">
                            ...
                            <li>
                                <Link :href="route('barangay.clearance')"
                                    ...
                                    :class="route().current('barangay.clearance')
                                        ? 'bg-blue-500 text-white font-semibold'
                                        : 'text-gray-500 hover:bg-gray-100 hover:text-gray-800'">
                                <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i
                                        class="bx bx-receipt"></i></span>
                                <span class="text-sm font-medium">Barangay Clearance</span>
                                </Link>
                            </li>
                            <li>
                                <Link :href="route('business.permit')"
                                    class="flex flex-row items-center h-12 rounded transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800"
                                    :class="route().current('business.permit')
                                        ? 'bg-blue-500 text-white font-semibold'
                                        : 'text-gray-500 hover:bg-gray-100 hover:text-gray-800'">
                                <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i
                                        class="bx bx-receipt"></i></span>
                                <span class="text-sm font-medium">Business Permits</span>
                                </Link>
                            </li>
                            <li>
                                <Link :href="route('indengency.certificates')"
                                    class="flex flex-row items-center h-12 rounded transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800"
                                    :class="route().current('indengency.certificates')
                                        ? 'bg-blue-500 text-white font-semibold'
                                        : 'text-gray-500 hover:bg-gray-100 hover:text-gray-800'">
                                <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i
                                        class="bx bx-receipt"></i></span>
                                <span class="text-sm font-medium">Indengency Certificates</span>
                                </Link>
                            </li>
                            <li>
                                <Link :href="route('residency.certificates')"
                                    class="flex flex-row items-center h-12 rounded transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800"
                                    :class="route().current('residency.certificates')
                                        ? 'bg-blue-500 text-white font-semibold'
                                        : 'text-gray-500 hover:bg-gray-100 hover:text-gray-800'">
                                <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i
                                        class="bx bx-receipt"></i></span>
                                <span class="text-sm font-medium">Residency Certificates</span>
                                </Link>
                            </li>
                            <li>
                                <Link :href="route('barangay.health.certificates')"
                                    class="flex flex-row items-center h-12 rounded transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800"
                                    :class="route().current('barangay.health.certificates')
                                        ? 'bg-blue-500 text-white font-semibold'
                                        : 'text-gray-500 hover:bg-gray-100 hover:text-gray-800'">
                                <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i
                                        class="bx bx-receipt"></i></span>
                                <span class="text-sm font-medium">Barangay Health Certificates</span>
                                </Link>
                            </li>
                            <li>
                                <Link :href="route('request.status')"
                                    class="flex flex-row items-center h-12 rounded transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800"
                                    :class="route().current('request.status')
                                        ? 'bg-blue-500 text-white font-semibold'
                                        : 'text-gray-500 hover:bg-gray-100 hover:text-gray-800'">
                                <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i
                                        class="bx bx-receipt"></i></span>
                                <span class="text-sm font-medium">Request Status</span>
                                </Link>
                            </li>
                            <li>
                                <a href="#"
