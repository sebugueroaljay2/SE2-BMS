...
class BarangayHealthCertificatesController extends Controller
{
    public function index(){
        return Inertia::render('Resident/Services/BarangayHealthCertificates',[
            'payment_method' => PaymentType::all(),
            'services' => Service::find(5),   
